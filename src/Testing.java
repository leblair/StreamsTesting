...
public class Testing {
    public static void main(String[] args) {
        ...
        //Encuentra el primero (se puede añadir una condición como expresion lambda) y si existe lo imprime
         cursos.stream()
                .findFirst()
        ...
        String stringConcatenado = list.stream()
                .map(s -> s.toString())
